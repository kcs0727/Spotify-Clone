...
export default function Sidebar() {
    ...
    return (
        <div className='w-[25%] min-w-[240px] h-full p-2 hidden md:flex flex-col gap-2 '>
            ...
            {/* home and search */}
            <div className='bg-[#121212] h-[230px] flex flex-col justify-around rounded'>
                ...
                <NavLink to="/" end className='flex items-center gap-3 p-2 pl-8 mt-1 cursor-pointer rounded-lg hover:bg-[#ffffff14]'>
                    <img src={assets.home_icon} className='w-6' alt='' />
                    <p className='font-bold'>Home</p>
                </NavLink>

                <NavLink to="/search" className='flex items-center gap-3 p-2 pl-8 mb-1 cursor-pointer rounded-lg hover:bg-[#ffffff14]'>
            ...
            {/* playlist and admin */}
            <div className='bg-[#121212] h-full rounded overflow-auto'>
                ...
                <div className='p-4 m-1 mt-4 shadow-md rounded-lg font-semibold flex flex-col items-start justify-start gap-1'>
                    ...
                    <p className='font-light text-sky-100'>we'll keep you update on new episodes</p>
                    <NavLink to='/podcast' className='px-4 py-1 bg-sky-100 text-black rounded-2xl mt-4 cursor-pointer hover:bg-white'>Browse Podcasts</NavLink>
                </div>

                {/* admin */}
                {user && user.role === "admin" && (
                    <NavLink to='/admin' className='font-semibold px-4 py-1 bg-sky-600 text-white rounded-2xl m-4 cursor-pointer hover:bg-sky-800'>Admin Dashboard</NavLink>
                )}
